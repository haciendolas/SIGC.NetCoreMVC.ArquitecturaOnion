    ...
    const Company = {
        _Init: function () {
            ...
            $('#btnQuitar').on('click', function () {
                ...
                $(this).hide();
                $('#hdCompanyLogoBandera').val('DELETE');
            });
        },
        _Clear: {
            ...
            fnCompanyDataTable: function () {             
                $('#dtCompany').dataTable({
                    ...
                    initComplete: function () {
                        const input = $('#dtCompany_filter input');
                        input.removeClass().addClass('form-control');
                        input.attr({ placeholder: 'Buscar empresa...', type: 'text' });
                        input.off();
            ...
            fnCompanyGet: function (CompanyID) {
                ...
                Uti.Ajax.Custom(options, function (response) {
                    ...
                    if (response.type === Uti.Message.Type.Query) {
                        ...
                        if (rowData.companyLogo.trim() != '') $('#btnQuitar').show();
        ...
        _Operation: {
            ...
            fnCompanyCreateUpdate: function () {
                if ($('#frmCompanyCreateUpdate').valid()) {                    
                    ...
                    const CompanyID = $('#txtCompanyID').val() == 'GENERADO' ? 0 : $('#txtCompanyID').val();
                    ...
                    formData.append('CompanyLogoBandera', $('#hdCompanyLogoBandera').val().trim());                    
