...
{
    internal class PageCompanyCreateRepository : IPageCompanyCreateRepository
    {
        private readonly string ConnectionString;
        private readonly ITransactionAccessor TransactionAccessor;
        public PageCompanyCreateRepository(IOptions<AppDbContext> Options, ITransactionAccessor TransactionAccessor)
        {
        ...
        public async Task<int> CreateAsync(PageCompany Model, CancellationToken CancellationToken = default)
        {
            ...
            using (SqlCommand Command = new SqlCommand()){
                    Command.CommandText = "Security.uspPageCompanyCreate";
