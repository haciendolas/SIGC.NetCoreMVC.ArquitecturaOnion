...
CREATE TABLE HumanResources.Person(
  ...
  PersonFirstName NVARCHAR(120) NOT NULL,
  PersonLastName NVARCHAR(120) NOT NULL,
  ...
  PersonCreatedUserName NVARCHAR(20) NOT NULL,
  PersonCreatedUserFullName NVARCHAR(80) NOT NULL,
  PersonCreatedDateTime DATETIME NOT NULL,  
  PersonUpdatedUserID INT, 
  PersonUpdatedUserName NVARCHAR(20),
  PersonUpdatedUserFullName NVARCHAR(80),
