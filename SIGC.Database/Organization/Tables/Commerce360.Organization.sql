...
CREATE Table Organization.Establishment(  
   ...
   EstablishmentName NVARCHAR(50) NOT NULL,
   EstablishmentAddress NVARCHAR(150) NOT NULL,  
   ...
   EstablishmentCreatedUserName NVARCHAR(20) NOT NULL,
   EstablishmentCreatedUserFullName NVARCHAR(80) NOT NULL,
